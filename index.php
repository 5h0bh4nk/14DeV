							                     	 ...
							                     	 <div class="container">
																  <form action="#" method="post" class="was-validated">
																    ...
																    <div class="form-group">
																      ...
																      <input type="text" class="form-control" id="admin_id" placeholder="Admin_id" name="admin_id" required>
																      <div class="valid-feedback">Valid.</div>
																      <div class="invalid-feedback">Please fill out this field.</div>
																    </div>
 		...
 		<div class="col-sm-12 col-lg-6 border-left border-danger">
			 ...
			 <div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade show active" id="nav-user-reg" role="tabpanel" aria-labelledby="nav-user-tab">
						<div class="container">
									  <form action="#" method="post" class="was-validated mt-3">
									    ...
									    <div class="form-group">
									      <label for="reginumber">Registration Number:</label>
									      <input type="text" class="form-control" id="reginumber" placeholder="Registration number" name="reginumber" required minlength="7">
									      <div class="valid-feedback">Valid.</div>
									      <div class="invalid-feedback">Please fill out this field.</div>
									    </div>
									    ...
									    <div class="form-group">
									     ...
									     <div class="form-group">
									      ...
									      <input type="Password" class="form-control" id="pass" placeholder="Choose Password" name="pass" required minlength="7">
									      <div class="valid-feedback">Valid.</div>
									      <div class="invalid-feedback">Please fill out this field.</div>
									    </div>
						...
						<div class="container">
									  <form action="#" method="post" class="was-validated mt-3">
									    ...
									    <div class="form-group">
									      ...
									      <input type="text" class="form-control" id="faculty_id" placeholder="Faculty Id" name="faculty_id" required minlength="7">
									      <div class="valid-feedback">Valid.</div>
									      <div class="invalid-feedback">Please fill out this field.</div>
									    </div>
